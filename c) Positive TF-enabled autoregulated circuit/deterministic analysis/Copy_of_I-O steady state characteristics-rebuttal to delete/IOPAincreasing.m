function [xr1,xr2,xr12,xa,xx] = IOPAincreasing(uuaa,m,ax)
...
sys_dyn = @(t,y) [(uu1+ka*y(5))*(1-y(1)-y(2)-y(4)+ y(3)) + (u01 + ap*y(2))*(1 - y(1) - y(4)) - (m*(e*bb + ee*y(4)))*y(1);...
                  (uu2+ka*y(5))*(1-y(1)-y(2)-y(4)+ y(3)) + (u02 + a*y(2) + ab*y(1))*(1 - y(2) - y(4)) - (mu*(b*e + ee*y(4)))*y(2);...
                 (u01 + ap*y(2))*(y(2) - y(3)) + (u02 + a*y(2) + ab*y(1))*(y(1) - y(3)) - (mu*(b*e + ee*y(4)) + m*(e*bb + ee*y(4)))*y(3);...
                 (u0a + uua + y(4))*(1-y(1)-y(2)-y(4)+ y(3)) - (e + ee*(y(1) + y(2)))*y(4);...
                  ax*y(4)-ex*y(5)];  
           

%% cell system initial conditions

 [T, Y] = ode45(sys_dyn, [0 N], [1 1 1 0 0]');

%  [T, Y] = ode45(sys_dyn, [0 N], [0 0 0 1 ax]');
